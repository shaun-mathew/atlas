...
test('recognition retries and scheduled reviews keep proficiency independent of spatial recall', async ({ page }) => {
  ...
  await expect(recall.locator('time')).toHaveAttribute('datetime', '2026-09-08T12:00:00.000Z');
  await answerWorldPoint(page, -52, -12);
  ...
  await expect(recognition.locator('time')).toHaveAttribute('datetime', '2026-09-11T12:10:00.000Z');
});
